...
martes     <- procesar_motos("z5_motos_salud_martes.xlsx", "Martes", capacidad_motos)
miercoles  <- procesar_motos("z5_motos_salud_miercoles.xlsx", "Miércoles", capacidad_motos)
sabado     <- procesar_motos("z5_motos_salud_sabado.xlsx", "Sábado", capacidad_motos)
